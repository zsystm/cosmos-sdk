...
var _ protoreflect.List = (*_Baz_5_list)(nil)

type _Baz_5_list struct {
	list *[]*timestamppb.Timestamp
}

func (x *_Baz_5_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_Baz_5_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_Baz_5_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*timestamppb.Timestamp)
	(*x.list)[i] = concreteValue
}

func (x *_Baz_5_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*timestamppb.Timestamp)
	*x.list = append(*x.list, concreteValue)
}

func (x *_Baz_5_list) AppendMutable() protoreflect.Value {
	v := new(timestamppb.Timestamp)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_Baz_5_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_Baz_5_list) NewElement() protoreflect.Value {
	v := new(timestamppb.Timestamp)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_Baz_5_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_Baz_expirations     protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Baz_expirations = md_Baz.Fields().ByName("expirations")
}
...
func (x *fastReflection_Baz) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.Expirations) != 0 {
		value := protoreflect.ValueOfList(&_Baz_5_list{list: &x.Expirations})
		if !f(fd_Baz_expirations, value) {
			return
		}
	}
}
...
func (x *fastReflection_Baz) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "Baz.expirations":
		if len(x.Expirations) == 0 {
			return protoreflect.ValueOfList(&_Baz_5_list{})
		}
		listValue := &_Baz_5_list{list: &x.Expirations}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: Baz"))
...
func (x *fastReflection_Baz) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "Baz.expirations":
		...
		value := &_Baz_5_list{list: &x.Expirations}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: Baz"))
...
func (x *fastReflection_Baz) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "Baz.expirations":
		list := []*timestamppb.Timestamp{}
		return protoreflect.ValueOfList(&_Baz_5_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: Baz"))
		}
...
func (x *Baz) GetExpirations() []*timestamppb.Timestamp {
	if x != nil {
