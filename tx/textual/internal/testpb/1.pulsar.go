...
var _ protoreflect.List = (*_Baz_1_list)(nil)

type _Baz_1_list struct {
	list *[]*Foo
}

func (x *_Baz_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_Baz_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_Baz_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*Foo)
	(*x.list)[i] = concreteValue
}

func (x *_Baz_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*Foo)
	*x.list = append(*x.list, concreteValue)
}

func (x *_Baz_1_list) AppendMutable() protoreflect.Value {
	v := new(Foo)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_Baz_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_Baz_1_list) NewElement() protoreflect.Value {
	v := new(Foo)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_Baz_1_list) IsValid() bool {
	return x.list != nil
}
...
var _ protoreflect.List = (*_Baz_4_list)(nil)

type _Baz_4_list struct {
	list *[]*v1beta1.Coin
}

func (x *_Baz_4_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_Baz_4_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_Baz_4_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_Baz_4_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_Baz_4_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_Baz_4_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_Baz_4_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_Baz_4_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_Baz_vote            protoreflect.FieldDescriptor
	fd_Baz_price           protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Baz_vote = md_Baz.Fields().ByName("vote")
	fd_Baz_price = md_Baz.Fields().ByName("price")
}
...
func (x *fastReflection_Baz) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Messages) != 0 {
		value := protoreflect.ValueOfList(&_Baz_1_list{list: &x.Messages})
		if !f(fd_Baz_messages, value) {
			return
		}
	}
	...
	if x.Vote != nil {
		...
		if !f(fd_Baz_vote, value) {
			return
		}
	}
	if len(x.Price) != 0 {
		value := protoreflect.ValueOfList(&_Baz_4_list{list: &x.Price})
		if !f(fd_Baz_price, value) {
			return
		}
	}
}
...
func (x *fastReflection_Baz) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "Baz.price":
		if len(x.Price) == 0 {
			return protoreflect.ValueOfList(&_Baz_4_list{})
		}
		listValue := &_Baz_4_list{list: &x.Price}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: Baz"))
...
func (x *fastReflection_Baz) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "Baz.price":
		...
		value := &_Baz_4_list{list: &x.Price}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: Baz"))
...
func (x *fastReflection_Baz) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "Baz.price":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_Baz_4_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: Baz"))
		}
...
// Baz is a sample message type used for testing repeated rendering.
type Baz struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Baz) GetPrice() []*v1beta1.Coin {
	if x != nil {
		return x.Price
	}
	return nil
...
var file__1_proto_rawDesc = []byte{
	...
	0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbb, 0x05, 0x0a, 0x01, 0x41, 0x12, 0x16, 0x0a,
	...
	0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x9c, 0x01, 0x0a, 0x03, 0x42, 0x61, 0x7a,
	...
	0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0x54, 0x0a, 0x12, 0x57, 0x65, 0x69, 0x67, 0x68,
	0x74, 0x65, 0x64, 0x56, 0x6f, 0x74, 0x65, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x16, 0x0a,
	...
	0x73, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x06, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0x72, 0x0a,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x6f, 0x74, 0x65, 0x72, 0x12, 0x2d, 0x0a, 0x07,
	0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e,
	0x57, 0x65, 0x69, 0x67, 0x68, 0x74, 0x65, 0x64, 0x56, 0x6f, 0x74, 0x65, 0x4f, 0x70, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x4a, 0x04, 0x08, 0x03, 0x10,
	0x04, 0x2a, 0x1f, 0x0a, 0x0b, 0x45, 0x6e, 0x75, 0x6d, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x12, 0x07, 0x0a, 0x03, 0x4f, 0x6e, 0x65, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x54, 0x77, 0x6f,
	0x10, 0x01, 0x2a, 0x89, 0x01, 0x0a, 0x0a, 0x56, 0x6f, 0x74, 0x65, 0x4f, 0x70, 0x74, 0x69, 0x6f,
	...
	0x4e, 0x4f, 0x5f, 0x57, 0x49, 0x54, 0x48, 0x5f, 0x56, 0x45, 0x54, 0x4f, 0x10, 0x04, 0x42, 0x33,
	0x42, 0x06, 0x31, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x27, 0x63, 0x6f, 0x73, 0x6d,
	0x6f, 0x73, 0x73, 0x64, 0x6b, 0x2e, 0x69, 0x6f, 0x2f, 0x74, 0x78, 0x2f, 0x74, 0x65, 0x78, 0x74,
...
var file__1_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file__1_proto_depIdxs = []int32{
	9,  // 0: A.COIN:type_name -> cosmos.base.v1beta1.Coin
	9,  // 1: A.COINS:type_name -> cosmos.base.v1beta1.Coin
	10, // 2: A.TIMESTAMP:type_name -> google.protobuf.Timestamp
	11, // 3: A.DURATION:type_name -> google.protobuf.Duration
	8,  // 4: A.MAP:type_name -> A.MAPEntry
	10, // 5: Foo.mtime:type_name -> google.protobuf.Timestamp
	3,  // 6: Foo.left:type_name -> Foo
	...
	6,  // 12: Vote.options:type_name -> WeightedVoteOption
	2,  // 13: A.MAPEntry.value:type_name -> A
