...
func (u UniqueKeyIndex) PrefixIterator(store ReadContext, prefix []protoreflect.Value, options IteratorOptions) (Iterator, error) {
...
func (u UniqueKeyIndex) RangeIterator(store ReadContext, start, end []protoreflect.Value, options IteratorOptions) (Iterator, error) {
...
func (u UniqueKeyIndex) Has(store ReadContext, keyValues []protoreflect.Value) (found bool, err error) {
...
func (u UniqueKeyIndex) Get(store ReadContext, keyValues []protoreflect.Value, message proto.Message) (found bool, err error) {
	key, err := u.GetKeyCodec().EncodeKey(keyValues)
	if err != nil {
		return false, err
	}
...
func (u UniqueKeyIndex) readValueFromIndexKey(store ReadContext, primaryKey []protoreflect.Value, _ []byte, message proto.Message) error {
