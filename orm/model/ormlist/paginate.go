...
//	if len(pageRequest.Key) != 0 && offset > 0 {
//		return nil, fmt.Errorf("can only specify one of cursor or offset")
//	}
//
//	iteratorOpts := ormtable.IteratorOptions{
//		Reverse: pageRequest.Reverse,
//		Cursor:  pageRequest.Key,
//	}
//	var it ormtable.Iterator
//	var err error
//	if pageRequest.Start != nil || request.End != nil {
...
//
//	haveMore := false
//	cursors := make([]ormtable.Cursor, 0, limit)
