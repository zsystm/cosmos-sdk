...
func (x exampleStore) BalanceTable() BalanceTable {
	return x.balance
}

func (x exampleStore) SupplyTable() SupplyTable {
	return x.supply
}

func (exampleStore) doNotImplement() {}

var _ ExampleStore = exampleStore{}

func NewExampleStore(db ormtable.Schema) (ExampleStore, error) {
