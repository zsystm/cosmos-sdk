...
func (x *_ModuleDescriptor_2_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message ModuleDescriptor at list field UsePackage as it is not of Message kind"))
}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.UsePackage) > 0 {
			for iNdEx := len(x.UsePackage) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.UsePackage[iNdEx])
				copy(dAtA[i:], x.UsePackage[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.UsePackage[iNdEx])))
				i--
				dAtA[i] = 0x12
			}
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				...
				x.UsePackage = append(x.UsePackage, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
type ModuleDescriptor struct {
	...
	// use_package refers to the name of a protobuf package that this module
	// uses and exposes to the world. In an app, only one module should "use"
	// or own a single protobuf package. It is assumed that the module uses
	// all of the .proto files in a single package.
	UsePackage []string `protobuf:"bytes,2,rep,name=use_package,json=usePackage,proto3" json:"use_package,omitempty"`
}
...
func (x *ModuleDescriptor) GetUsePackage() []string {
	if x != nil {
		return x.UsePackage
	}
	return nil
...
var file_cosmos_app_v1alpha1_module_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x50, 0x0a, 0x10, 0x4d, 0x6f, 0x64,
	...
	0x52, 0x08, 0x67, 0x6f, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x75, 0x73,
	0x65, 0x5f, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x0a, 0x75, 0x73, 0x65, 0x50, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x3a, 0x66, 0x0a, 0x09, 0x69,
	0x73, 0x5f, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x12, 0x1f, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	...
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x44,
	0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x6f, 0x72, 0x52, 0x08, 0x69, 0x73, 0x4d, 0x6f, 0x64,
	0x75, 0x6c, 0x65, 0x42, 0xd6, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d,
	0x6f, 0x73, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x42,
...
var file_cosmos_app_v1alpha1_module_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
var file_cosmos_app_v1alpha1_module_proto_depIdxs = []int32{
	1, // 0: cosmos.app.v1alpha1.is_module:extendee -> google.protobuf.MessageOptions
	0, // 1: cosmos.app.v1alpha1.is_module:type_name -> cosmos.app.v1alpha1.ModuleDescriptor
