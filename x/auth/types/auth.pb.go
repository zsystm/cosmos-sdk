...
func (m *ParamsUpdateResponse) Reset()         { *m = ParamsUpdateResponse{} }
func (m *ParamsUpdateResponse) String() string { return proto.CompactTextString(m) }
func (*ParamsUpdateResponse) ProtoMessage()    {}
func (*ParamsUpdateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7e1f7e915d020d2d, []int{3}
}
func (m *ParamsUpdateResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ParamsUpdateResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ParamsUpdateResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ParamsUpdateResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ParamsUpdateResponse.Merge(m, src)
}
func (m *ParamsUpdateResponse) XXX_Size() int {
	return m.Size()
}
func (m *ParamsUpdateResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ParamsUpdateResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ParamsUpdateResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*ParamsUpdateResponse)(nil), "cosmos.auth.v1beta1.ParamsUpdateResponse")
}
...
var fileDescriptor_7e1f7e915d020d2d = []byte{
	...
	,
}
...
type MsgClient interface {
	UpdateParams(ctx context.Context, in *Params, opts ...grpc.CallOption) (*ParamsUpdateResponse, error)
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *Params, opts ...grpc.CallOption) (*ParamsUpdateResponse, error) {
	out := new(ParamsUpdateResponse)
...
type MsgServer interface {
	UpdateParams(context.Context, *Params) (*ParamsUpdateResponse, error)
}
...
func (*UnimplementedMsgServer) UpdateParams(ctx context.Context, req *Params) (*ParamsUpdateResponse, error) {
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).UpdateParams(ctx, req.(*Params))
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "cosmos/auth/v1beta1/auth.proto",
}
...
func (m *ParamsUpdateResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ParamsUpdateResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ParamsUpdateResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ParamsUpdateResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ParamsUpdateResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ParamsUpdateResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ParamsUpdateResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
