...
func TestCancelUnbondingDelegation(t *testing.T) {
	...
	depModules := []string{"auth", "bank", "gov", "slashing"}
	// replaceModules := ReplaceModule{
	...
	// 	// {keeper: stakingKeeper},
	// 	// {keeper: anotherStakingKeeper},
	// 	// ...
	// 	{keeper: stakingKeeper},
	// }
	// testutil.TestSimApp(depModules, stakingKeeper, Modules{
	// 	keeper:        stakingKeeper,
	// 	accountKeeper: accountKeeper,
	// 	bankkeeper:    bankKeeper,
	// }, config)

	app := testutil.TestSimApp(depModules, stakingKeeper, accountKeeper, bankKeeper, config)
	...
	// accounts
	delAddrs := sims.AddTestAddrsIncremental(bankKeeper, stakingKeeper, ctx, 2, sdk.NewInt(10000))
