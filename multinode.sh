...
# $DAEMON start --minimum-gas-prices 0.0000001stake --mode validator --home $DAEMON_HOME_1
# $DAEMON start --minimum-gas-prices 0.0000001stake --mode validator --home $DAEMON_HOME_2
# $DAEMON start --minimum-gas-prices 0.0000001stake --mode validator1
...
[Service]
Type=simple        github.com/cosmos/cosmos-sdk/codec/proto_codec.go:180 +0x45
User=$USER
